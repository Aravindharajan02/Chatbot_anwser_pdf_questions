...
if pdf_file is not None:
    ...
    flag= True
    while(flag==True):
        user_input=st.text_input("Enter your Query here. If no Query or exit type 'bye' and don't worry about error just write your query",)
        ...
        if user_input =='bye':
            ...
            st.sidebar.write("As per PDF Bot got this sentence ---> ",responce(user_input))
